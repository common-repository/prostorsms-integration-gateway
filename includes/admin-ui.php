...
$sms = new prostorsms_gateway();

if (
        ($_SERVER['REQUEST_METHOD'] === 'POST')
        && (check_admin_referer('prostorsmssave', 'prostorsms'))
        && (wp_verify_nonce($_POST['prostorsms'], 'prostorsmssave'))
    ) {
...
<form action="options-general.php?page=prostorsms" method="post" class="form-horizontal">
    ...
    <?php wp_nonce_field('prostorsmssave', 'prostorsms'); ?>
    ...
    <div class="panel-heading">
        <div class="row">
            ...
            <div class="col-sm-6 text-right">
                ...
                Ваш баланс:  <b><?php print_r($balance);?></b>&nbsp;&nbsp;
                <a href="https://prostor-sms.ru/bill/" target="_blank">[пополнить]</a>&nbsp;&nbsp;
                <a href="https://prostor-sms.ru/?crmplatform=wordpress" target="_blank">[на сайт]</a>
            </div>
        </div>
    </div>
